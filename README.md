...
- ⚠️ Non-commercial usage only
- ⚠️ Proper attribution
- ⚠️ ShareAlike (derivatives under same license)
...
If you use IDM-VTON in your research, please cite the original paper:

```bibtex
@article{choi2023idm,
  title={Identity-Aware Invisible-Mask Virtual Try-on with Generative Diffusion Models},
  author={Choi, Sugyeong and Park, Gyeongsik and Choo, Jaesik},
...
- **Diffusers Library**: [HuggingFace Diffusers](https://huggingface.co/docs/diffusers)
...
- **IP-Adapter**: [TencentARC](https://github.com/tencent-ailab/ip-adapter)

---

## 📞 Support & Contact

- **Issues**: Report bugs via [GitHub Issues](https://github.com/yourusername/IDM-VTON/issues)
...
- Original research team for IDM-VTON methodology
- HuggingFace for the Diffusers library
- Meta AI for DensePose and Detectron2
- OpenPose contributors
...
**Made with ❤️ for the fashion and AI community**
